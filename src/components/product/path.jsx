                ...
                <div className=" mx-auto sm:px-4 ">
                    <nav>
                        <ol className="flex flex-wrap list-reset pt-3 pb-3 py-4 px-4 mb-4 bg-gray-200 rounded ">
                            <li className="inline-block px-1 py-2 "><a href="/" className=" text-text-color">Trang chủ</a></li>
                            <li className="inline-block px-1 py-2 "><a href="/allproduct" className=" text-text-color ">/ Sản phẩm</a></li>
